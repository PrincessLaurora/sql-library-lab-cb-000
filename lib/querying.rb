...
def select_series_title_with_most_human_characters
  "SELECT series.title, COUNT(characters.species) FROM series JOIN characters ON series.id = characters.id GROUP BY characters.species ORDER BY characters.species HAVING characters.species = 'human';"
end
