...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name FROM characters JOIN characters_books ON character_books.character_id = character.id GROUP by characters.name ORDER by character_books DESC;"
end
