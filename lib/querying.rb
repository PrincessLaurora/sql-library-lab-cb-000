...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series JOIN characters ON series.id = characters.id WHERE characters.species = 'human' GROUP BY characters.species ORDER BY characters.species;"
end
