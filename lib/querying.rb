...
def select_series_title_with_most_human_characters
  "SELECT series.title, COUNT(characters.species) FROM series JOIN characters ON series.id = character_id GROUP BY characters.species ORDER BY characters.species WHERE characters.species = 'human';"
end
